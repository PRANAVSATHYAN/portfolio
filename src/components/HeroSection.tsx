          ...
          <div className="order-1 md:order-2 flex justify-center fly-up">
            <div className="relative">
              ...
              <div className="rounded-lg overflow-hidden border-8 border-background/20 shadow-xl relative z-10">
                <img
                  src="https://media.licdn.com/dms/image/v2/D5603AQGT3bmmiviHAQ/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1707862255006?e=1752105600&v=beta&t=irfdx24E9RdMydsBfsjbvagOfEzNJ2uM8-5R1BTk09Y"
                  alt="Profile"
